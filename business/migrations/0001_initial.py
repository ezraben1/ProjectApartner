    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('apartment', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='rooms', to='business.apartment')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(upload_to='business/images', validators=[business.validators.validate_file_size])),
                ('room', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='images', to='business.room')),
            ],
        ),
        migrations.CreateModel(
            name='Review',
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reviews', to='business.room')),
            ],
        ),
        migrations.CreateModel(
            name='Contract',
            fields=[
                ...
                ('room', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='contract', to='business.room')),
            ],
        ),
        migrations.CreateModel(
            name='ApartmentImage',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(help_text='The image of the apartment.', upload_to='business/images', validators=[business.validators.validate_file_size])),
                ('apartment', models.ForeignKey(help_text='The apartment the image belongs to.', on_delete=django.db.models.deletion.CASCADE, related_name='images', to='business.apartment')),
            ],
        ),
    ]
